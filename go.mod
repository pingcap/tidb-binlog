...
require (
	...
	github.com/pingcap/parser v0.0.0-20210720071422-1663c6237918
	github.com/pingcap/tidb v1.1.0-beta.0.20211122110949-1e156bc40af0
	...
	github.com/tikv/pd v1.1.0-beta.0.20210909055238-605dc238b9a9
