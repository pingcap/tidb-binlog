...
func newPbPoint(cfg *DBConfig) (Point, error){
...
// Save implements SaveCheckPointor.Save interface.
...
// Check implements SaveCheckPointor.Check interface.
...
// Pos implements SaveCheckPointor.Pos interface.
