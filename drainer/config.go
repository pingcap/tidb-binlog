...
const (
	...
	defaultSafeLeadTime    = 20 // 20 minute
)
...
type Config struct {
	*flag.FlagSet
	...
	SafeLeadTime    int             `toml:"safe-lead-time" json:"safe-lead-time"`
...
func NewConfig() *Config {
	...
	fs.IntVar(&cfg.SafeLeadTime, "safe-lead-time", defaultSafeLeadTime, "how many minutes drainer sync before the commit ts in checkpoint file or initial-commit-ts")
