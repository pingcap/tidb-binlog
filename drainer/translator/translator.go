...
type SQLTranslator interface {
	...
	SetConfig(hasImplicitCol, useInsert bool)
	...
	GenUpdateSQLs(schema string, table *model.TableInfo, rows [][]byte, commitTS int64, safeMode bool) ([]string, [][]string, [][]interface{}, error)
