...
type Binlogger interface {
	...
	ReadFrom(from binlog.Pos, nums int32, notify chan *binlog.Entity) error
...
func (b *binlogger) ReadFrom(from binlog.Pos, nums int32, notify chan *binlog.Entity) error {
